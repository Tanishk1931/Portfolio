...
const Layout = ({ children }) => {
  return (
    <div className="min-h-screen bg-background text-text-primary selection:bg-accent selection:text-background font-sans relative">
      <CustomCursor />
      <Navbar />
      <main className="max-w-7xl mx-auto px-6 py-24 md:py-32 relative z-10">
        {children}
      </main>
      <footer className="w-full text-center py-8 text-text-secondary text-xs font-mono relative z-10">
